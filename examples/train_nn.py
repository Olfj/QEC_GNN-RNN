...
import argparse
# python examples/train_nn.py --d 5 --p 0.001 --t 50 --dt 2 --batch_size 32 --n_batches 10 --n_epochs 2 --load_path distance3
# kernprof -l -v examples/train_nn.py -- --d 5 --p 0.001 --t 50 --dt 2 --batch_size 32 --n_batches 10 --n_epochs 2
